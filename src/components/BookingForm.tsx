        ...
        <form action={addBookingVal}>
                    <table className="table-auto border-seperate border-spacing-2">
                        <tbody>
                            ...
                            <tr>
                                <td>Booking Ends: </td>
                                <td><input type="date" required name="bookingEnd" id="bookingEnd" min={bookingStart} max={bookingEndMax} onChange={(event)=>{setBookingEnd(event.target.value)}} className='w-full'></input></td>
                            </tr>
                        </tbody>
                    </table>
